...
# Как работает
## Краткое описание
Как уж было сказано, это простейшее CRUD-приложение, работающее с данными о звонках в службу спасения. Данные взяты с сайта 
...
6. Просмотр количества звонков в службу спасения за конкретный час (GET /api/rows/<HOUR>)
